...
{{--                {!!  substr(trans('sentence.home.service_text') , 0 , 400)!!}--}}
          ...
          <!-- Item -->
            <li class="about box animated" data-animation="rotateInDownLeft" data-animation-delay="300">
              <a style="display: flex;justify-content: center;align-items: center;padding: 20px;cursor: grab !important"
                 href="{{$value->page=='active'?route('user-service-show',[app()->getLocale(),$value->slug]):'#'}}" class="about-logo">
                <img src="{{ $value->icon_hover?url($value->icon_hover):url('adib/icon_2.png') }}" class="icon_2" alt="{{$value->title}}">
  ...
  <section id="team2" class="main-content">
    <div class="content">
      <h1 class="main_title_a animated" data-animation="fadeInUp" data-animation-delay="300">
        مدیران شرکت
      </h1>
      <div class="team-items slide-boxes">
        @foreach ($team as $item)
          <div class="item animated" data-animation="rollIn" data-animation-delay="0">
              ...
              @endif
              <div class="socials">
                  <a class="instagram" href="{{$item->instagram}}"><i class="fa fa-instagram"></i></a>
                  <a class="whatsapp" href="{{$item->whatsapp}}"><i class="fa fa-whatsapp"></i></a>
                  <a class="linkedin" href="{{$item->linkedin}}"><i class="fa fa-linkedin"></i></a>
                  <a class="envelope" href="mailto:{{$item->email}}"><i class="fa fa-envelope"></i></a>
              </div>
          </div>
        @endforeach
      </div>
      <a href="{{ route('team-company',$locale )}}">
        <h3 class="main_title_a animated href" data-animation="fadeInUp" data-animation-delay="300" style="margin: 0">
  ...
  @if(count($article) > 0)
    ...
    <section id="blog" class="main-content">
      ...
      <div class="content" style="padding: 30px 0 ">
        ...
        <div class="team-items slide-boxes">
          @foreach($article as $row)
              <div class="item animated" data-animation="rollIn" data-animation-delay="0">
                ...
                <h5 class="blog-short">...{!! substr($row->short_text, 0 , 300) !!}</h5>
        ...
        <!-- End Team -->
        <a href="{{ route('user-article-show',[$locale , $article[0]->slug])}}">
          <h3 class="main_title_a animated" data-animation="fadeInUp" data-animation-delay="300" style="margin: 0">
            {{trans('sentence.home.allarticle')}}
          </h3>
        </a>
      </div>
      <!-- End Content -->
